...
namespace AuthenticationUtility
{
    public class OAuthHelper
    {
        ...
        public static string GetAuthenticationHeader2(bool useWebAppAuthentication, String[] appCon)
        {
            string aadTenant = appCon[4];
            string aadClientAppId = appCon[5];
            string aadClientAppSecret = appCon[6];
            string aadResource = appCon[3];
            ...
            {
                // OAuth through username and password.
                string username = appCon[1];
                string password = appCon[2];
